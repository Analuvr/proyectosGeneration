...
public class UserController {
    ...
    */
    ...
    // Nuevo metodo Post para implementar rawPassword
    @PostMapping
    public ResponseEntity<User> createUser(@RequestBody User newUser) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(userService.createUser(newUser.getUsername(), newUser.getEmail(), newUser.getPassword())); // 201
        // Tratarla como una clase que nos permite realizar acciones, body toma el cuerpo del metodo que nos permite crear un usuario
    }
